...
2. The current version is the first major revision since the first Morey_os demo version was uploaded on GitHub. It provides support for the Arduino Uno board, several controllers from the AVR Mega series, and the ATmega4809 controller from the AVR Mega0 series. This version is released as a demo solely for demonstration purposes to relevant stakeholders. Support for Arduino Mega board and many remaining controllers of Mega series ans Mega0 series will be added soon.
