#include "avr_xmega_uartd1.h"
#if defined(PLATFORM_SUPPORT_UART) && defined(UARTD1_AVAILABLE) && ( UARTD1_ENABLE == 1 )

#if ( (COMPILER == AVR_STUDIO) || ( COMPILER == WIN_AVR ) || ( COMPILER == AVR_GCC ))
	#include <avr/interrupt.h>
#endif

#if defined(UARTD1_RX_BUFFER_CONF)
	#define UARTD1_RX_BUFFER_SIZE UARTD1_RX_BUFFER_CONF
#elif defined(UARTD1_RX_BUFFER_DEFAULT)
	#define UARTD1_RX_BUFFER_SIZE UARTD1_RX_BUFFER_DEFAULT
#else
	#define UARTD1_RX_BUFFER_SIZE 64
#endif

#ifdef UARTD1_TX_INTERRUPT_ENABLE
	#if defined(UARTD1_TX_BUFFER_CONF)
		#define UARTD1_TX_BUFFER_SIZE UARTD1_TX_BUFFER_CONF
	#elif defined(UARTD1_TX_BUFFER_DEFAULT)
		#define UARTD1_TX_BUFFER_SIZE UARTD1_TX_BUFFER_DEFAULT
	#else
		#define UARTD1_TX_BUFFER_SIZE 64
	#endif
#endif

#ifdef UARTD1_TX_DISABLE
	#ifdef UARTD1_RX_DISABLE
...
#define UART_REMAP 		PORTD.REMAP
#define UART_STATUS 	USARTD1.STATUS
#define UART_CONTROL1 	USARTD1.CTRLB
#define UART_CONTROL2 	USARTD1.CTRLC
#define UART_INTERRUPT	USARTD1.CTRLA
#define UART_DATA 		USARTD1.DATA
#define UART_BAUD_LOW 	USARTD1.BAUDCTRLA
#define UART_BAUD_HIGH 	USARTD1.BAUDCTRLB
...
#define RX_BUFFER_SIZE_TEMP 					UARTD1_RX_BUFFER_SIZE
#define TX_BUFFER_SIZE_TEMP 					UARTD1_TX_BUFFER_SIZE
...
// UART Rx Functions
	...
	static void flush(void)
	{
		...
		interrupt [USARTD1_RXC] void usartd1_rxc_isr(void)
	#endif
	{
...
// UART Tx Functions
	...
	static mos_uint8_t txComplete(void)
	{
		...
		#elif COMPILER == CODEVISION_AVR
			interrupt [USARTD1_TXC] void usartd1_txc_isr(void)
		#endif
		{
...
const struct serial_driver avr_xmega_uartd1_driver = {
	begin,
	available,
	read,
	flush,
