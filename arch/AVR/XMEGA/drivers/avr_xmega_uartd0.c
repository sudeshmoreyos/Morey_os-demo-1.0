#include "avr_xmega_uartd0.h"
#if defined(PLATFORM_SUPPORT_UART) && defined(UARTD0_AVAILABLE) && ( UARTD0_ENABLE == 1 )
...
#if defined(UARTD0_RX_BUFFER_CONF)
	#define UARTD0_RX_BUFFER_SIZE UARTD0_RX_BUFFER_CONF
#elif defined(UARTD0_RX_BUFFER_DEFAULT)
	#define UARTD0_RX_BUFFER_SIZE UARTD0_RX_BUFFER_DEFAULT
#else
	#define UARTD0_RX_BUFFER_SIZE 64
#endif

#ifdef UARTD0_TX_INTERRUPT_ENABLE
	#if defined(UARTD0_TX_BUFFER_CONF)
		#define UARTD0_TX_BUFFER_SIZE UARTD0_TX_BUFFER_CONF
	#elif defined(UARTD0_TX_BUFFER_DEFAULT)
		#define UARTD0_TX_BUFFER_SIZE UARTD0_TX_BUFFER_DEFAULT
	#else
		#define UARTD0_TX_BUFFER_SIZE 64
	#endif
#endif

#ifdef UARTD0_TX_DISABLE
	#ifdef UARTD0_RX_DISABLE
...
#define UART_STATUS 	USARTD0.STATUS
#define UART_CONTROL1 	USARTD0.CTRLB
#define UART_CONTROL2 	USARTD0.CTRLC
#define UART_INTERRUPT	USARTD0.CTRLA
#define UART_DATA 		USARTD0.DATA
#define UART_BAUD_LOW 	USARTD0.BAUDCTRLA
#define UART_BAUD_HIGH 	USARTD0.BAUDCTRLB
...
#define RX_BUFFER_SIZE_TEMP 					UARTD0_RX_BUFFER_SIZE
#define TX_BUFFER_SIZE_TEMP 					UARTD0_TX_BUFFER_SIZE
...
// UART Rx Functions
	...
	static void flush(void)
	{
		...
		interrupt [USARTD0_RXC] void usartd0_rxc_isr(void)
	#endif
	{
...
// UART Tx Functions
	...
	static mos_uint8_t txComplete(void)
	{
		...
		#elif COMPILER == CODEVISION_AVR
			interrupt [USARTD0_TXC] void usartd0_txc_isr(void)
		#endif
		{
...
const struct serial_driver avr_xmega_uartd0_driver = {
	begin,
	available,
	read,
	flush,
