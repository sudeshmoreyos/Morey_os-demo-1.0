#include "avr_xmega_uartc0.h"
#if defined(PLATFORM_SUPPORT_UART) && defined(UARTC0_AVAILABLE) && ( UARTC0_ENABLE == 1 )

#if ( (COMPILER == AVR_STUDIO) || ( COMPILER == WIN_AVR ) || ( COMPILER == AVR_GCC ))
	#include <avr/interrupt.h>
#endif

#if defined(UARTC0_RX_BUFFER_CONF)
	#define UARTC0_RX_BUFFER_SIZE UARTC0_RX_BUFFER_CONF
#elif defined(UARTC0_RX_BUFFER_DEFAULT)
	#define UARTC0_RX_BUFFER_SIZE UARTC0_RX_BUFFER_DEFAULT
#else
	#define UARTC0_RX_BUFFER_SIZE 64
#endif

#ifdef UARTC0_TX_INTERRUPT_ENABLE
	#if defined(UARTC0_TX_BUFFER_CONF)
		#define UARTC0_TX_BUFFER_SIZE UARTC0_TX_BUFFER_CONF
	#elif defined(UARTC0_TX_BUFFER_DEFAULT)
		#define UARTC0_TX_BUFFER_SIZE UARTC0_TX_BUFFER_DEFAULT
	#else
		#define UARTC0_TX_BUFFER_SIZE 64
	#endif
#endif

#ifdef UARTC0_TX_DISABLE
	#ifdef UARTC0_RX_DISABLE
...
#define UART_STATUS 	USARTC0.STATUS
#define UART_CONTROL1 	USARTC0.CTRLB
#define UART_CONTROL2 	USARTC0.CTRLC
#define UART_INTERRUPT	USARTC0.CTRLA
#define UART_DATA 		USARTC0.DATA
#define UART_BAUD_LOW 	USARTC0.BAUDCTRLA
#define UART_BAUD_HIGH 	USARTC0.BAUDCTRLB
...
#define RX_BUFFER_SIZE_TEMP 					UARTC0_RX_BUFFER_SIZE
#define TX_BUFFER_SIZE_TEMP 					UARTC0_TX_BUFFER_SIZE
...
const struct serial_driver avr_xmega_uartc0_driver = {
	begin,
	available,
	read,
	flush,
