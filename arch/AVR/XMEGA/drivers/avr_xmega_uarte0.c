#include "avr_xmega_uarte0.h"
#if defined(PLATFORM_SUPPORT_UART) && defined(UARTE0_AVAILABLE) && ( UARTE0_ENABLE == 1 )

#if ( (COMPILER == AVR_STUDIO) || ( COMPILER == WIN_AVR ) || ( COMPILER == AVR_GCC ))
	#include <avr/interrupt.h>
#endif

#if defined(UARTE0_RX_BUFFER_CONF)
	#define UARTE0_RX_BUFFER_SIZE UARTE0_RX_BUFFER_CONF
#elif defined(UARTE0_RX_BUFFER_DEFAULT)
	#define UARTE0_RX_BUFFER_SIZE UARTE0_RX_BUFFER_DEFAULT
#else
	#define UARTE0_RX_BUFFER_SIZE 64
#endif

#ifdef UARTE0_TX_INTERRUPT_ENABLE
	#if defined(UARTE0_TX_BUFFER_CONF)
		#define UARTE0_TX_BUFFER_SIZE UARTE0_TX_BUFFER_CONF
	#elif defined(UARTE0_TX_BUFFER_DEFAULT)
		#define UARTE0_TX_BUFFER_SIZE UARTE0_TX_BUFFER_DEFAULT
	#else
		#define UARTE0_TX_BUFFER_SIZE 64
	#endif
#endif

#ifdef UARTE0_TX_DISABLE
	#ifdef UARTE0_RX_DISABLE
...
#define UART_STATUS 	USARTE0.STATUS
#define UART_CONTROL1 	USARTE0.CTRLB
#define UART_CONTROL2 	USARTE0.CTRLC
#define UART_INTERRUPT	USARTE0.CTRLA
#define UART_DATA 		USARTE0.DATA
#define UART_BAUD_LOW 	USARTE0.BAUDCTRLA
#define UART_BAUD_HIGH 	USARTE0.BAUDCTRLB
...
#define RX_BUFFER_SIZE_TEMP 					UARTE0_RX_BUFFER_SIZE
#define TX_BUFFER_SIZE_TEMP 					UARTE0_TX_BUFFER_SIZE
...
// UART Rx Functions
	...
	static void flush(void)
	{
		...
		interrupt [USARTE0_RXC] void usarte0_rxc_isr(void)
	#endif
	{
...
// UART Tx Functions
	...
	static mos_uint8_t txComplete(void)
	{
		...
		#elif COMPILER == CODEVISION_AVR
			interrupt [USARTE0_TXC] void usarte0_txc_isr(void)
		#endif
		{
...
const struct serial_driver avr_xmega_uarte0_driver = {
	begin,
	available,
	read,
	flush,
