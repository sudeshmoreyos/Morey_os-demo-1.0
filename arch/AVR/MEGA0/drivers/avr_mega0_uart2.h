...
#ifndef AVR_MEGA0_UART2_H
#define AVR_MEGA0_UART2_H
...
#include "../../../../platform.h"
	...
	// Defining Controller specific UART Macros from OS Serial Macros
		...
		#include "avr_mega0_uart_defines.h"
			...
			#define Serial avr_mega0_uart2_driver
			#define Serial0 Serial
			
		#elif SERIAL1_PORT == UART2_PORT
			
			#define Serial1 avr_mega0_uart2_driver
			
		#elif SERIAL2_PORT == UART2_PORT
			
			#define Serial2 avr_mega0_uart2_driver
			
		#elif SERIAL3_PORT == UART2_PORT
		
			#define Serial3 avr_mega0_uart2_driver
		#endif
		
		extern const struct serial_driver avr_mega0_uart2_driver;	
		
	#endif // UART2_ENABLE == 1
	
#endif // defined(PLATFORM_SUPPORT_UART) && defined(UART2_AVAILABLE)

#endif // AVR_MEGA0_UART2_H