...
// UART2_RX_BUFFER_DEFAULT
// UART2_TX_INTERRUPT_ENABLE
// UART2_TX_BUFFER_CONF
// UART2_TX_BUFFER_DEFAULT
// avr_mega0_uart2_driver
// MCU_UART2_RX_INTERRUPT_ISR
// MCU_UART2_TX_INTERRUPT_ISR
// USART2_RXC_vect
// USART2_DRE_vect
// UART2_TX_PIN
// UART2_RX_PIN
// UART2_AT_F4_F5_ENABLE

#include "avr_mega0_uart2.h"

#if defined(PLATFORM_SUPPORT_UART) && defined(UART2_AVAILABLE) && (UART2_ENABLE == 1)
...
#ifndef UART2_RX_DISABLE
	#if defined(UART2_RX_BUFFER_CONF)
		#define RX_BUFFER_SIZE_TEMP UART2_RX_BUFFER_CONF
	#elif defined(UART2_RX_BUFFER_DEFAULT)
		#define RX_BUFFER_SIZE_TEMP UART2_RX_BUFFER_DEFAULT
	#else
		#define RX_BUFFER_SIZE_TEMP 64
	#endif
#endif

#ifndef UART2_TX_DISABLE
	#ifdef UART2_TX_INTERRUPT_ENABLE
		#if defined(UART2_TX_BUFFER_CONF)
			#define TX_BUFFER_SIZE_TEMP UART2_TX_BUFFER_CONF
		#elif defined(UART2_TX_BUFFER_DEFAULT)
			#define TX_BUFFER_SIZE_TEMP UART2_TX_BUFFER_DEFAULT
		#else
...
#ifdef UART2_TX_DISABLE
	#ifdef UART2_RX_DISABLE
...
#define UART_STATUS 			USART2.STATUS
#define UART_ERROR_STATUS		USART2.RXDATAH
#define UART_CONTROL1 			USART2.CTRLA
#define UART_CONTROL2 			USART2.CTRLB
#define UART_CONTROL3 			USART2.CTRLC
#define UART_RX_DATA 			USART2.RXDATAL
#define UART_TX_DATA 			USART2.TXDATAL
#define UART_BAUD				USART2.BAUD
#define UART_PORTMUX			PORTMUX.USARTROUTEA
#define UART_PORTMUX_BIT		4
#define UART_DRIVER				avr_mega0_uart2_driver

#define UART_RX_INTERRUPT_ISR	USART2_RXC_vect
#define UART_TX_INTERRUPT_ISR	USART2_DRE_vect
