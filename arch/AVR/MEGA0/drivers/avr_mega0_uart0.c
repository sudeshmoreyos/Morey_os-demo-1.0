...
// UART0_TX_PIN
// UART0_RX_PIN
// UART0_AT_A4_A5_ENABLE

#include "avr_mega0_uart0.h"
...
#define UART_ERROR_STATUS		USART0.RXDATAH
#define UART_CONTROL1 			USART0.CTRLA
#define UART_CONTROL2 			USART0.CTRLB
#define UART_CONTROL3 			USART0.CTRLC
...
#define UART_TX_INTERRUPT_ISR	USART0_DRE_vect
