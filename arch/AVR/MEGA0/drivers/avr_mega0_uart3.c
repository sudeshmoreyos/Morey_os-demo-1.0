...
// UART3_RX_BUFFER_DEFAULT
// UART3_TX_INTERRUPT_ENABLE
// UART3_TX_BUFFER_CONF
// UART3_TX_BUFFER_DEFAULT
// avr_mega0_uart3_driver
// MCU_UART3_RX_INTERRUPT_ISR
// MCU_UART3_TX_INTERRUPT_ISR
// USART3_RXC_vect
// USART3_DRE_vect
// UART3_TX_PIN
// UART3_RX_PIN
// UART3_AT_B4_B5_ENABLE

#include "avr_mega0_uart3.h"

#if defined(PLATFORM_SUPPORT_UART) && defined(UART3_AVAILABLE) && (UART3_ENABLE == 1)
...
#ifndef UART3_RX_DISABLE
	#if defined(UART3_RX_BUFFER_CONF)
		#define RX_BUFFER_SIZE_TEMP UART3_RX_BUFFER_CONF
	#elif defined(UART3_RX_BUFFER_DEFAULT)
		#define RX_BUFFER_SIZE_TEMP UART3_RX_BUFFER_DEFAULT
	#else
		#define RX_BUFFER_SIZE_TEMP 64
	#endif
#endif

#ifndef UART3_TX_DISABLE
	#ifdef UART3_TX_INTERRUPT_ENABLE
		#if defined(UART3_TX_BUFFER_CONF)
			#define TX_BUFFER_SIZE_TEMP UART3_TX_BUFFER_CONF
		#elif defined(UART3_TX_BUFFER_DEFAULT)
			#define TX_BUFFER_SIZE_TEMP UART3_TX_BUFFER_DEFAULT
		#else
...
#ifdef UART3_TX_DISABLE
	#ifdef UART3_RX_DISABLE
...
#define UART_STATUS 			USART3.STATUS
#define UART_ERROR_STATUS		USART3.RXDATAH
#define UART_CONTROL1 			USART3.CTRLA
#define UART_CONTROL2 			USART3.CTRLB
#define UART_CONTROL3 			USART3.CTRLC
#define UART_RX_DATA 			USART3.RXDATAL
#define UART_TX_DATA 			USART3.TXDATAL
#define UART_BAUD				USART3.BAUD
#define UART_PORTMUX			PORTMUX.USARTROUTEA
#define UART_PORTMUX_BIT		6
#define UART_DRIVER				avr_mega0_uart3_driver

#define UART_RX_INTERRUPT_ISR	USART3_RXC_vect
#define UART_TX_INTERRUPT_ISR	USART3_DRE_vect
