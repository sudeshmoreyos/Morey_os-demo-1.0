...
#ifndef AVR_MEGA0_UART0_H
#define AVR_MEGA0_UART0_H
...
#include "../../../../platform.h"
	...
	// Defining Controller specific UART Macros from OS Serial Macros
		...
		#include "avr_mega0_uart_defines.h"
			...
			#define Serial avr_mega0_uart0_driver
			#define Serial0 Serial
			
		#elif SERIAL1_PORT == UART0_PORT
			
			#define Serial1 avr_mega0_uart0_driver
			
		#elif SERIAL2_PORT == UART0_PORT
			
			#define Serial2 avr_mega0_uart0_driver
			
		#elif SERIAL3_PORT == UART0_PORT
		
			#define Serial3 avr_mega0_uart0_driver
		#endif
		
		extern const struct serial_driver avr_mega0_uart0_driver;		
	#endif
#endif
