...
* @{
* \brief Documentation of boot.h header file for Atmega8 controller    
...
/**
* \name MACROS : Mega8 OS TIMER Config Macros declaration
* \brief Define configuration macros for OS TIMER
* @{
*/
...
#define OS_TICKING_INTERRUPT	TIMER0_OVF_vect
...
#else 
#error Incorrect CONTROLLER_FREQ : For Atmega8 Controller MOREY_OS supports only four frequencies (Hz) i.e. 1000000UL, 8000000UL, 12000000UL & 16000000UL
