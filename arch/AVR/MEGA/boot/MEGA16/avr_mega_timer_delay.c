...
* @{ \defgroup avr_mega_timer_delay_MEGA16_c
* @{
* \brief Documentaion of avr_mega_timer_delay.c source file for atmega16 controller.   
* \author Sudesh Morey <sudesh.moreyos@gmail.com>
*
* This source file implements TIMER Delay functions for atmega16 controller.
* @}
*/
