...
* @{ \defgroup avr_mega_timer_delay_MEGA2560_c
* @{
* \brief Documentaion of avr_mega_timer_delay.c source file for atmega2560 controller.   
* \author Sudesh Morey <sudesh.moreyos@gmail.com>
*
* This source file implements TIMER Delay functions for atmega2560 controller.
* @}
*/
