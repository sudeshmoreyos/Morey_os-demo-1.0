...
* @{ \defgroup boot_MEGA128_c
* @{
* \brief Documentaion of boot. source file for Atmega128 controller
* \author Sudesh Morey <sudesh.moreyos@gmail.com>
*
* This source file implements Atmega128 boot functions
* @}
*/
...
#ifdef MEGA128_DEBUG_LEVEL_CONF
	#define MEGA128_DEBUG_LEVEL 		MEGA128_DEBUG_LEVEL_CONF
#else
	#define MEGA128_DEBUG_LEVEL 		MEGA128_DEBUG_NONE
#endif

#if MEGA128_DEBUG_LEVEL > MEGA128_DEBUG_NONE    
    #include "../../../../../os/lib/debug.h"
#endif

#define MEGA128_DEBUG_MSG(msg)			DEBUG_MSG_CONST3_LN("<DEBUG MEGA128> ",NULL,msg)
#define MEGA128_DEBUG_MSG_TEMP(msg) 		DEBUG_MSG_CONST3_LN("<DEBUG MEGA128 USER> ",NULL,msg)
    
#if MEGA128_DEBUG_LEVEL == MEGA128_DEBUG_NONE    
	#define MEGA128_DEBUG_MSG1(msg)
	#define MEGA128_DEBUG_MSG2(msg)
	#define MEGA128_DEBUG_MSG3(msg)
	#define MEGA128_DEBUG_MSG_USER(msg)

#elif MEGA128_DEBUG_LEVEL == MEGA128_DEBUG_USER    
	#define MEGA128_DEBUG_MSG1(msg)    
	#define MEGA128_DEBUG_MSG2(msg)
	#define MEGA128_DEBUG_MSG3(msg)
	#define MEGA128_DEBUG_MSG_USER(msg) 	MEGA128_DEBUG_MSG_TEMP(msg)

#elif MEGA128_DEBUG_LEVEL == MEGA128_DEBUG_LEVEL1    
	#define MEGA128_DEBUG_MSG1(msg) 		MEGA128_DEBUG_MSG(msg)
	#define MEGA128_DEBUG_MSG2(msg)
	#define MEGA128_DEBUG_MSG3(msg)
	#define MEGA128_DEBUG_MSG_USER(msg)

#elif MEGA128_DEBUG_LEVEL == MEGA128_DEBUG_LEVEL2    
	#define MEGA128_DEBUG_MSG1(msg) 		MEGA128_DEBUG_MSG(msg)
	#define MEGA128_DEBUG_MSG2(msg) 		MEGA128_DEBUG_MSG(msg)
	#define MEGA128_DEBUG_MSG3(msg)
	#define MEGA128_DEBUG_MSG_USER(msg)

#elif MEGA128_DEBUG_LEVEL == MEGA128_DEBUG_LEVEL3    
	#define MEGA128_DEBUG_MSG1(msg) 		MEGA128_DEBUG_MSG(msg)    
	#define MEGA128_DEBUG_MSG2(msg) 		MEGA128_DEBUG_MSG(msg)
	#define MEGA128_DEBUG_MSG3(msg) 		MEGA128_DEBUG_MSG(msg)
	#define MEGA128_DEBUG_MSG_USER(msg)

#else
    #error Invalid MEGA128 DEBUG LEVEL, supported levels : MEGA128_DEBUG_LEVEL1, MEGA128_DEBUG_LEVEL2, MEGA128_DEBUG_LEVEL3, MEGA128_DEBUG_USER
#endif
...
static void timer_init(void)
{
		...
		// For OS_TIMER_TYPE == TIMER_0, Timer0 is used
			...
			MEGA128_DEBUG_MSG1("Selected Option : Timer type = TIMER_0  and Controller frequency = 16 Mhz");
			...
			MEGA128_DEBUG_MSG1("Selected Option : Timer type = TIMER_0  and Controller frequency = 12 Mhz");
			MEGA128_DEBUG_MSG1("For XTAL_FREQ = 12 MHz, 0.27% error in timer calculations, strongly recommended to use other frequencies");
			...
			MEGA128_DEBUG_MSG1("Selected Option : Timer type = TIMER_0  and Controller frequency = 8 Mhz");
			...
			MEGA128_DEBUG_MSG1("Selected Option : Timer type = TIMER_0  and Controller frequency = 1 Mhz");
		...
		// 12 Mhz Frequency generate error of 0.16% for all milli-second delays
			...
			MEGA128_DEBUG_MSG1("Selected Option : Timer type = TIMER_2  and Controller frequency = 16 Mhz");
			...
			MEGA128_DEBUG_MSG1("Selected Option : Timer type = TIMER_2  and Controller frequency = 12 Mhz");
			MEGA128_DEBUG_MSG1("For XTAL_FREQ = 12MHz, 0.16% error in timer calculations, strongly recommended to use other frequencies");
			...
			MEGA128_DEBUG_MSG1("Selected Option : Timer type = TIMER_2  and Controller frequency = 8 Mhz");
			...
			MEGA128_DEBUG_MSG1("Selected Option : Timer type = TIMER_2  and Controller frequency = 1 Mhz");
		...
		// Clock Resolution is 1 milli second without any error for any milli-second delays for all frequencies
			...
			MEGA128_DEBUG_MSG1("Selected Option : Timer type = TIMER_1  and Controller frequency = 16 Mhz");
			...
			MEGA128_DEBUG_MSG1("Selected Option : Timer type = TIMER_1  and Controller frequency = 12 Mhz");
			...
			MEGA128_DEBUG_MSG1("Selected Option : Timer type = TIMER_1  and Controller frequency = 8 Mhz");
			...
			MEGA128_DEBUG_MSG1("Selected Option : Timer type = TIMER_1  and Controller frequency = 1 Mhz");
		...
		// For OS_TIMER_TYPE == TIMER_3, timer3 is used
		// Clock Resolution is 1 milli second without any error for any milli-second delays for all frequencies
        
		#if CONTROLLER_FREQ == 16000000UL
        
			MEGA128_DEBUG_MSG1("Selected Option : Timer type = TIMER_3  and Controller frequency = 16 Mhz");
...
{  
    ...
    MEGA128_DEBUG_MSG2("Watchdog Timer initiated");
}
...
static void sleep_init(void)
{
    ...
    MEGA128_DEBUG_MSG2("Sleep Mode Initiated");
}

void sleep(void)
{
    MEGA128_DEBUG_MSG3("Sleeping");
