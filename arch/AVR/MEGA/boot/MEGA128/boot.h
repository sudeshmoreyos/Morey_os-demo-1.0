...
// words to replace : MEGA128, atmega128

/** \addtogroup headers_MEGA128
* @{ \defgroup boot_MEGA128_h
* @{
* \brief Documentaion of boot.h header file for Atmega128 controller    
* \author Sudesh Morey <sudesh.moreyos@gmail.com>
*
* This header file implements Atmega128 boot functions
*
* **USER DEFINED MACROS** that can be used in boot.h (These macros should be declared in config.h file) are :
*1. **MEGA128_DEBUG_LEVEL_CONF** \n
*=> Allowed values : {MEGA128_DEBUG_NONE, MEGA128_DEBUG_USER, MEGA128_DEBUG_LEVEL1, MEGA128_DEBUG_LEVEL2, MEGA128_DEBUG_LEVEL3} \n
*=> Eg. Declaration in config.h : #define MEGA128_DEBUG_LEVEL_CONF MEGA128_DEBUG_LEVEL1 \n
*=> Default value : MEGA128_DEBUG_NONE \n
*=> Usage Description : This macro can be defined to diagnose different execution steps of boot.h or boot.c for Atmega128 controller,
*with increasing levels (i.e. level 1 2 3) deeper execution steps can be diagnosed. MEGA128_DEBUG_USER level enables MEGA128_DEBUG_MSG_USER Macro.
*To use this, user should manually write MEGA128_DEBUG_MSG_USER(msg) inside code sections of boot.h or boot.c to be diagnosed. \n
*\n
*2. **FREQ** \n
*=> Allowed values : {1000000, 8000000, 12000000, 16000000} \n
*=> Eg. Declaration in Makefile : FREQ = 1000000 \n
*=> Default value : 16000000 \n
*=> Usage Description : For Atmega128 Controller MOREY_OS supports only four frequencies i.e. 1000000 (1 Mhz), 8000000 (8 Mhz),
...
*=> Allowed values : {TIMER_0, TIMER_1, TIMER_2, TIMER_3} \n
*=> Eg. Declaration in config.h : #define OS_TIMER_TYPE_CONF TIMER_3 \n
*=> Default value : TIMER_3 \n
*=> Usage Description : For Atmega128 Controller MOREY_OS supports only four values i.e. TIMER_0, TIMER_1, TIMER_2, TIMER_3. 
* OS_TIMER_TYPE = TIMER_0 uses timer0 (8 bit), OS_TIMER_TYPE = TIMER_2 uses timer2 (8 bit), OS_TIMER_TYPE = TIMER_1 uses timer1 (16 bit) 
* OS_TIMER_TYPE = TIMER_3 uses timer1 (16 bit) of Atmega128 controller. If user do not define OS_TIMER_TYPE_CONF in config.h header, 
* by default OS_TIMER_TYPE = TIMER_3 ( timer3 ) is selected. For Atmega128 controller Morey_OS works most efficiently when 
* OS_TIMER_TYPE_CONF is set to TIMER_1 or TIMER_3.
* @}
*/
...
#include "../../../../../platform.h"
	...
	#include <avr/io.h>
#else
	#error Incorrect COMPILER, Supported compilers for Atmega128 are AVR_STUDIO, WIN_AVR, AVR_GCC and CODEVISION_AVR
#endif
...
/**
* \name MACROS : Atmega128 Boot Debug Levels
* \brief Define different levels for Atmega128 boot debugging
* @{
*/
#define MEGA128_DEBUG_NONE 0
#define MEGA128_DEBUG_USER 1
#define MEGA128_DEBUG_LEVEL1 2
#define MEGA128_DEBUG_LEVEL2 3
#define MEGA128_DEBUG_LEVEL3 4 
///@}
	...
	#else 
		#error Incorrect CONTROLLER_FREQ : For Atmega128 Controller MOREY_OS supports only four frequencies (Hz) i.e. 1000000, 8000000, 12000000 & 16000000
	#endif
	...
	#define COMPARE_MATCH_MAX_TICK 				250
     ...
     // For OS_TIMER_TYPE == TIMER_1 timer1 is used, max accuracy achieved is 1 milli second for all frequencies
	...
	#define COMPARE_MATCH_MAX_TICK 				62500
     ...
     // For OS_TIMER_TYPE == TIMER_3 timer3 is used, max accuracy achieved is 1 milli second for all frequencies
...
#else 
	#error Incorrect OS_TIMER_TYPE : For Atmega128 Controller MOREY_OS supports only following values i.e. TIMER_0, TIMER_1, TIMER_2 and TIMER_3
