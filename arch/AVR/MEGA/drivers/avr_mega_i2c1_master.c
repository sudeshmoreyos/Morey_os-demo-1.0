...
#include "avr_mega_i2c1_master.h"
...
#define I2C_STATUS 			TWSR1
#define I2C_CONTROL 		TWCR1
#define I2C_DATA 			TWDR1
#define I2C_BAUD			TWBR1
...
const struct i2c_master_driver avr_mega_i2c1_master_driver = {
	begin,
	end,
	transfer
};
