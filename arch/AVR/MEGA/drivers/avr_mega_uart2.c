...
#define UART_CONTROL1 			UCSR2B
#define UART_CONTROL2 			UCSR2C
#define UART_DATA 				UDR2
#define UART_BAUD_LOW 			UBRR2L
#define UART_BAUD_HIGH 			UBRR2H
#define UART_DRIVER				avr_mega_uart2_driver
...
#ifdef MCU_UART2_RX_INTERRUPT_ISR
	#define UART_RX_INTERRUPT_ISR	MCU_UART2_RX_INTERRUPT_ISR
#else
	#define UART_RX_INTERRUPT_ISR	USART2_RX_vect
#endif

#ifdef MCU_UART2_RX_INTERRUPT_ISR
	#define UART_TX_INTERRUPT_ISR	MCU_UART2_TX_INTERRUPT_ISR
#else
	#define UART_TX_INTERRUPT_ISR	USART2_UDRE_vect
#endif
