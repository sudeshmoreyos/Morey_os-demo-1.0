...
#ifndef AVR_MEGA_UART1_H
#define AVR_MEGA_UART1_H
...
#include "../../../../platform.h"
	...
	// Defining Controller specific UART Macros from OS Serial Macros
		...
		#include "avr_mega_uart_defines.h"
			...
			#define Serial avr_mega_uart1_driver
			#define Serial0 Serial
			
		#elif SERIAL1_PORT == UART1_PORT
			
			#define Serial1 avr_mega_uart1_driver
			
		#elif SERIAL2_PORT == UART1_PORT
			
			#define Serial2 avr_mega_uart1_driver
			
		#elif SERIAL3_PORT == UART1_PORT
		
			#define Serial3 avr_mega_uart1_driver
		#endif
		
		extern const struct serial_driver avr_mega_uart1_driver;		
	#endif
#endif
