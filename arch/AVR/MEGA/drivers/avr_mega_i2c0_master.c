...
#include "avr_mega_i2c0_master.h"
...
#define I2C_STATUS 			TWSR0
#define I2C_CONTROL 		TWCR0
#define I2C_DATA 			TWDR0
#define I2C_BAUD			TWBR0
...
const struct i2c_master_driver avr_mega_i2c0_master_driver = {
	begin,
	end,
	transfer
};
