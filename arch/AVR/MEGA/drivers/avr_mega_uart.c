#include "avr_mega_uart.h"
	...
	#define UART_RX_BUFFER_SIZE UART_RX_BUFFER_CONF
#elif defined(UART_RX_BUFFER_DEFAULT)
	#define UART_RX_BUFFER_SIZE UART_RX_BUFFER_DEFAULT
#else
	#define UART_RX_BUFFER_SIZE 64
		...
		#define UART_TX_BUFFER_SIZE UART_TX_BUFFER_CONF
	#elif defined(UART_TX_BUFFER_DEFAULT)
		#define UART_TX_BUFFER_SIZE UART_TX_BUFFER_DEFAULT
	#else
...
#define RX_BUFFER_SIZE_TEMP 					UART_RX_BUFFER_SIZE
#define TX_BUFFER_SIZE_TEMP 					UART_TX_BUFFER_SIZE
